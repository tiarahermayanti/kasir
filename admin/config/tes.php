...
$no = 1;
$query = $con->prepare("SELECT barang.nama_brg, transaksi.tgl_trans, transaksi.waktu, barang.modal, barang.harga_jual, transaksi.jml, transaksi.diskon, transaksi.kasir from barang JOIN transaksi ON barang.kd_brg=transaksi.kd_brg WHERE tgl_trans BETWEEN " . $tgl . "GROUP By transaksi.kd_trans");
$query->execute();
